...
export default function ContactFAB() {
  return (
    <a
      ...
      className="fixed bottom-7 right-7 z-[888] flex h-[54px] w-[54px] items-center justify-center rounded-full bg-[#25D366] shadow-fab transition-all duration-250 hover:scale-[1.08]"
    >
